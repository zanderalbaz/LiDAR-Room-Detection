...
def train_3d_cnn(train_data, test_data, input_shape, num_classes):# Tried: adam, SGD, messing with learning rates 0.01, 0.02, 0.005, 0.0025, 0.00125, 0.000125
    model = create_3d_cnn(input_shape, num_classes)
    
    opt = Adam(learning_rate=0.000125)
